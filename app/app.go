...
import (
	...
	elolamodule "elola/x/elola"
	elolamodulekeeper "elola/x/elola/keeper"
	elolamoduletypes "elola/x/elola/types"
...
type App struct {
	*baseapp.BaseApp
	...
	ElolaKeeper elolamodulekeeper.Keeper
...
func New(
	...
	app.ElolaKeeper = *elolamodulekeeper.NewKeeper(
		appCodec,
		keys[elolamoduletypes.StoreKey],
		keys[elolamoduletypes.MemStoreKey],
		app.GetSubspace(elolamoduletypes.ModuleName),
	)
	elolaModule := elolamodule.NewAppModule(appCodec, app.ElolaKeeper, app.AccountKeeper, app.BankKeeper)
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey sdk.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(elolamoduletypes.ModuleName)
